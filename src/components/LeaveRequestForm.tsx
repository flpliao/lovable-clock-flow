...
export function LeaveRequestForm({ onSubmit }: LeaveRequestFormProps) {
  ...
  async function handleSubmit(data: LeaveFormValues) {
    ...
    const leaveRequest = {
      ...
      start_date: formatDateForDatabase(data.start_date), // 使用本地時區格式化
      end_date: formatDateForDatabase(data.end_date), // 使用本地時區格式化
    ...
    console.log('即將提交的請假申請:', leaveRequest);
