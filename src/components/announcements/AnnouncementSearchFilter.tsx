      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 backdrop-blur-xl bg-white/30 border-white/40 text-white placeholder:text-white/60 font-medium shadow-lg h-12"
          />
        </div>
        ...
        <div className="w-full sm:w-48">
          <Select value={selectedCategory} onValueChange={onCategoryChange}>
            <SelectTrigger className="backdrop-blur-xl bg-white/30 border-white/40 text-white font-medium shadow-lg h-12">
