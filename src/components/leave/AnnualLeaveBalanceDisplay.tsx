...
interface AnnualLeaveBalanceDisplayProps {
...
export function AnnualLeaveBalanceDisplay({ currentUser, balanceData }: AnnualLeaveBalanceDisplayProps) {
  if (!currentUser) {
    return (
  ...
  const { totalDays, usedDays, remainingDays, yearsOfService } = balanceData;
      ...
      <div className="bg-white/10 rounded-2xl p-4 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-white font-semibold">{currentUser.department}</p>
          </div>
          <div>
