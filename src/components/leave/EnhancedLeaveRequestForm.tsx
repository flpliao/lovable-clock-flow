...
export function EnhancedLeaveRequestForm({ onSubmit }: EnhancedLeaveRequestFormProps) {
  ...
  const mockLeaveUsage: LeaveUsage = {
    annualUsed: 5,
    personalUsed: 2,
    sickUsed: 3,
    marriageUsed: false,
      ...
      const timeoutId = setTimeout(async () => {
        try {
          const result = await LeaveValidationService.validateLeaveRequest(
            ...
            currentUser,
            mockLeaveUsage,
            [] // existing requests would come from context
          );
  ...
  const selectedLeaveType = watchedValues.leave_type;
  const canSubmit = validationResult?.isValid && !isValidating;
    ...
    <div className="space-y-6">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          {validationResult && (
            <div className="backdrop-blur-xl bg-white/20 border border-white/30 rounded-3xl shadow-xl p-6">
              <h3 className="text-lg font-semibold text-white drop-shadow-md mb-4">表單檢查</h3>
