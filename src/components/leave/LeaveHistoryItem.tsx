...
export const LeaveHistoryItem: React.FC<LeaveHistoryItemProps> = ({
  ...
  return <div onClick={handleClick} className="backdrop-blur-xl border border-white/30 rounded-2xl p-4 transition-all duration-200 cursor-pointer bg-violet-400">
