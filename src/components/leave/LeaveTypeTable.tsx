          ...
          <Table>
            <TableHeader>
              <TableRow className="border-white/30 hover:bg-white/20 transition-colors">
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">假別代碼</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">中文名稱</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">英文名稱</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">薪資</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">年度重置</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">最大天數</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">狀態</TableHead>
                <TableHead className="text-slate-700 font-semibold text-sm py-3 px-4">操作</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {leaveTypes.map((leaveType) => (
                ...
                >
                  ...
                  <TableCell className="font-semibold text-slate-800 py-3 px-4">{leaveType.name_zh}</TableCell>
                  <TableCell className="text-slate-700 font-medium py-3 px-4">{leaveType.name_en}</TableCell>
                  <TableCell className="py-3 px-4">
                    <Badge 
                  ...
                  <TableCell className="text-slate-800 font-medium py-3 px-4">
                  ...
                  <TableCell className="py-3 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      {leaveType.is_system_default && (
                        <Badge 
                          variant="outline" 
                          className="text-violet-800 border-violet-300 bg-violet-50 font-medium px-2 py-1 rounded-lg"
                        >
                          系統預設
                        </Badge>
                      )}
                  ...
                  <TableCell className="py-3 px-4">
                    <div className="flex items-center gap-1">
                      <Button 
                        ...
                        className="hover:bg-blue-100 text-blue-700 hover:text-blue-800 rounded-lg border border-transparent hover:border-blue-200 transition-all duration-200"
                      >
                      ...
                      <Button 
                        ...
                        className="hover:bg-red-100 text-red-600 hover:text-red-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg border border-transparent hover:border-red-200 transition-all duration-200"
                      >
