  ...
  return (
    <div className="backdrop-blur-2xl bg-white/15 border border-white/25 rounded-3xl shadow-2xl p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h4 className="text-lg font-medium text-black">時間設定</h4>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-3">
          <Label htmlFor="startTime" className="flex items-center gap-2 text-black font-medium">
        ...
        <div className="space-y-3">
          <Label htmlFor="endTime" className="flex items-center gap-2 text-black font-medium">
