...
interface EditWorkScheduleFormProps {
  ...
  onSubmit: (slug: string, data: UpdateWorkScheduleData) => void;
  workSchedule: WorkSchedule | null;
}

export interface EditWorkScheduleFormRef {
  form: UseFormReturn<CreateWorkScheduleFormData>;
  reset: () => void;
}

const EditWorkScheduleForm = forwardRef<EditWorkScheduleFormRef, EditWorkScheduleFormProps>(
  ({ open, onOpenChange, onSubmit, workSchedule }, ref) => {
    ...
    const handleSubmit = (data: CreateWorkScheduleFormData) => {
      ...
      onSubmit(workSchedule.slug, workScheduleData);
    };
...
EditWorkScheduleForm.displayName = 'EditWorkScheduleForm';
