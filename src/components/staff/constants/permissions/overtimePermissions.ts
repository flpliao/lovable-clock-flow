...
export const OVERTIME_PERMISSION_DEFINITIONS = [
  ...
  },
  {
    ...
    code: OVERTIME_PERMISSIONS.UPDATE_OWN_OVERTIME,
    name: '修改自己的加班申請',
    category: 'overtime',
  ...
  },
  {
    ...
    code: OVERTIME_PERMISSIONS.VIEW_SUBORDINATE_OVERTIME,
    name: '查看下屬加班記錄',
    category: 'overtime',
  ...
  },
  {
    ...
    code: OVERTIME_PERMISSIONS.EXPORT_OVERTIME,
    name: '匯出加班資料',
    category: 'overtime',
  ...
  },
  {
    ...
    code: OVERTIME_PERMISSIONS.VIEW_OVERTIME_REPORTS,
    name: '查看加班報表',
    category: 'overtime',
  ...
  },
  {
    ...
    code: OVERTIME_PERMISSIONS.MANAGE_OVERTIME_REPORTS,
    name: '管理加班報表',
    category: 'overtime',
