...
import { useLocationCheckIn } from './useLocationCheckIn';
...
export const useCheckIn = (userId: string) => {
  ...
  const { distance, onLocationCheckIn: performLocationCheckIn } = useLocationCheckIn(userId, actionType);
