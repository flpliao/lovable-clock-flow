...
const ApprovalCenter = () => {
  ...
  const handleOvertimeApprove = async (request: any) => {
    await handleOvertimeApproval(request.id, true);
  };

  const handleOvertimeReject = async (request: any) => {
    await handleOvertimeApproval(request.id, false, '拒絕原因');
  };
