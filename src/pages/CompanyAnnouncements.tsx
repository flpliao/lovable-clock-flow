...
const CompanyAnnouncements: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-safe relative overflow-hidden bg-gradient-to-br from-blue-400 via-blue-500 to-purple-600">
      {/* 動態背景漸層 */}
      ...
      <div className="absolute top-3/5 right-1/3 w-2 h-2 bg-white/40 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute top-1/2 left-2/3 w-1 h-1 bg-white/50 rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
      <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-blue-200/40 rounded-full animate-float" style={{ animationDelay: '6s' }}></div>
