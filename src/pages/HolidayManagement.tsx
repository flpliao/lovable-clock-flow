...
import { Calendar, BarChart3, Settings, Timer, MapPin } from 'lucide-react';
        ...
        <div className="w-full px-4 lg:px-8 pb-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className={`grid w-full ${isAdmin() ? 'grid-cols-3' : 'grid-cols-2'} bg-white/30 backdrop-blur-xl rounded-2xl border border-white/40 p-1 shadow-lg h-14`}>
              ...
              {isAdmin() && <TabsTrigger value="settings" className="text-gray-800 data-[state=active]:bg-white/50 data-[state=active]:text-gray-900 data-[state=active]:shadow-lg rounded-xl font-semibold transition-all duration-300 py-3 px-6 text-base data-[state=active]:backdrop-blur-xl flex items-center gap-2">
            ...
            <div className="mt-8">
              ...
              {isAdmin() && <TabsContent value="settings" className="mt-0">
                  <HolidaySettings />
                </TabsContent>}
            </div>
          </Tabs>
