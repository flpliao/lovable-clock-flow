            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div className="px-4 pb-4">
                ...
                <TabsContent value="view" className="mt-0">
                  {pendingLeaveRequest ? <LeaveRequestDetail leaveRequest={pendingLeaveRequest} isApprover={isApproverForRequest(pendingLeaveRequest)} /> : <div className="text-center py-12">
