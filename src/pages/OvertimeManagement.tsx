...
import OvertimeApprovalDetail from '@/components/overtime/OvertimeApprovalDetail';
...
const OvertimeManagement = () => {
  ...
  if (selectedRequest) {
    return <OvertimeApprovalDetail request={selectedRequest} onBack={handleBackToList} onApprovalComplete={handleApprovalComplete} />;
  }
  ...
  // 計算需要審核的總數
  const totalPendingForApproval = pendingRequests.length + missedCheckinRequests.length;
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 pb-6">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <ApprovalStats
            ...
            pendingOvertime={pendingRequests.length}
