...
const ScheduleFormWithStaff = () => {
  ...
  return <ScheduleForm staffList={staffList} />;
};
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    {canViewAllSchedules && (
                      <p className="text-white/80 text-sm">完整排班管理權限</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            <Tabs defaultValue="view" className="w-full">
              ...
              <div className="mt-8">
                <TabsContent value="view" className="mt-0">
                  <ScheduleCalendarWithStaff />
                </TabsContent>

                {canManageSchedules && (
                  <TabsContent value="create" className="mt-0">
                    <ScheduleFormWithStaff />
                  </TabsContent>
                )}
