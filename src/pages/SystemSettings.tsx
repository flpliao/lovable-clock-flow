...
const SystemSettings = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-blue-400 via-blue-500 to-purple-600 relative overflow-hidden mobile-fullscreen pt-80 md:pt-84">
      {/* 動態背景漸層 */}
