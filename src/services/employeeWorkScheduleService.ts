...
export class EmployeeWorkScheduleService {
  // 取得所有員工工作排程
  static async getAllEmployeeWorkSchedules(): Promise<Employee[]> {
  ...
  // 取得員工工作排程列表（分頁）
  static async getEmployeeWithWorkSchedules({
    page,
    per_page,
    search,
    employee_id,
  ...
  // 批量同步員工工作排程
  static async bulkSyncEmployeeWorkSchedules({
    month,
    year,
    schedules,
  }: {
